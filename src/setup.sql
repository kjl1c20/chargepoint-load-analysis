...
CREATE TABLE IF NOT EXISTS chargepoint_analysis.silver.charge_points (
    ...
    latitude            DOUBLE                COMMENT 'WGS84 latitude (feed value, or approved override)',
    longitude           DOUBLE                COMMENT 'WGS84 longitude (feed value, or approved override)',
    coord_source        STRING                COMMENT 'feed | override — lineage of the coordinates',
